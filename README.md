...
| `stampCommand`             | Command agents should run to stamp hashes. Conventionally scoped to summary freshness (e.g. `--summaries-only`) — see `refsStampCommand` for the separate `--refs` command                                                                                                                                                                                                           |
